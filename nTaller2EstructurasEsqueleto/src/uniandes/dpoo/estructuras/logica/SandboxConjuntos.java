...
public class SandboxConjuntos
{
    ...
    {
    	ArrayList<String> retorno = new ArrayList<String>(arbolCadenas);
        return retorno;
    }
    ...
    public List<String> getCadenasComoListaInvertida( )
    {
    	...
    	Collections.reverse(lista);//Interesante ver como podemos usar los metodos de collection
    ...
    {
    	Collection<String> retorno = arbolCadenas.tailSet(cadena);
        return retorno;
    }
    ...
    {
    	if (arbolCadenas.isEmpty() == true) {return;}
    	else {
    ...
    public void reiniciarConjuntoCadenas( List<Object> objetos )
    {
    	...
    	NavigableSet<String> nuevo = new TreeSet<String>();
    ...
    {
        TreeSet<String> nuevo = new TreeSet<>(Collections.reverseOrder());
        nuevo.addAll(arbolCadenas);
        return nuevo;
    }
    ...
    public boolean compararElementos( String[] otroArreglo )
    {
        ...
        for (String elemento: otroArreglo) {
        	if(arbolCadenas.contains(elemento) == false) {
        		todos = false;
        		break;
        	};
        }
