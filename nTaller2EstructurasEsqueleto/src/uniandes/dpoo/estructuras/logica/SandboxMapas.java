...
public class SandboxMapas
{
    ...
    {
    	List<String> retorno = new ArrayList<String>(mapaCadenas.values());
    ...
    {
    	List<String> retorno = new ArrayList<String>(mapaCadenas.keySet());
    	Collections.sort(retorno);
    ...
    public Collection<String> getLlaves( )
    {
    	...
    	for (String elemento: listaLlaves) {
    ...
    {
        Set<String> diferentes = new HashSet<String>();
        List<String> lista = getValoresComoLista();
     ...
     */
    public void eliminarCadenaConValor( String valorP )
    {
    ...
    public void reiniciarMapaCadenas( List<Object> objetos )
    {
    	...
    	for (Object elemento: objetos) {
    		String elemento1 = elemento.toString();
    		nuevo.put(elemento1, String.valueOf(contador)); 
    		contador ++;//Buscamos darle un valor unico
    	}
    ...
    {
    	Map <String,String> nuevo = new HashMap<String,String>();
    	Collection<String> llavesMayuscula = getLlaves();
    	for(String elemento: llavesMayuscula) {
    		for(Map.Entry<String, String> pareja : mapaCadenas.entrySet()) {
        		String llave = pareja.getKey();
        		String valor = pareja.getValue();
        		if (elemento.equalsIgnoreCase(llave)) {
        			nuevo.put(elemento, valor);
        		}
        	}
